...
// 创建节点表
      ...
      `INSERT OR IGNORE INTO confs (setting_key, setting_value, description) VALUES
        ...
        ('node_check_mode', 'local', '节点检测模式：internal=内置 TCP 可达性、local=本机 Python 脚本、remote=远程 EdgeOne 地址'),
        ('node_check_remote_url', '', '当 node_check_mode=remote 时使用的远程检测站点根地址，例如 https://example.com'),
